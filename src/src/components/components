  ...
  return (
    <section style={{maxWidth: 900, margin: "24px auto 0", textAlign: "center"}}>
      ...
      <div style={{display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap"}}>
        <a href="https://streamyard.com/6u894xi3cw" target="_blank" rel="noopener"
      ...
      <p style={{fontSize: 12, color:"#555", marginTop: 12}}>Hosted by <strong>Wildman Tom B</strong>. Ages 12+.</p>
    </section>
  );
}
